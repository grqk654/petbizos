      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '52px 24px 0' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14, marginBottom: 52 }}>
          {[
            ...
            { cat:'Groomers',    icon:'✂', count:3,  color:C.amberLight, border:C.amberBorder, slug:'groomers' },
            { cat:'Boarding',    icon:'🏠', count:2,  color:C.blueLight,  border:C.blueBorder,  slug:'boarding' },
            { cat:'Vets',        icon:'🏥', count:0,  color:C.greenLight, border:'#C0DD97',     slug:'vets' },
...
const DirectoryPage = ({ setPage, initialCat = 'all', initialHood = 'all' }) => {
  ...
  const seo = catFilter !== 'all' && catSEO[catFilter]
    ...
    : hoodFilter !== 'all'
    ? hoodSEO(hoodFilter)
    : { h1: 'Find Pet Services Near You', desc: '77 verified providers across Brooklyn. Free to browse.' }
